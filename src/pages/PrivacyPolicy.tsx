      ...
      <div className="container mx-auto px-6 md:px-12 max-w-4xl">
        ...
        >
          ...
          <div className="prose prose-invert max-w-none space-y-8 text-muted-foreground">
            ...
            <h2 className="text-3xl font-bold text-foreground mt-12">1. Information We Collect</h2>
            <p>We may collect:</p>
            ...
            <h2 className="text-3xl font-bold text-foreground mt-12">2. How We Use Your Information</h2>
            ...
            <h2 className="text-3xl font-bold text-foreground mt-12">3. Sharing of Information</h2>
            ...
            <h2 className="text-3xl font-bold text-foreground mt-12">4. Cookies and Tracking</h2>
            ...
            <h2 className="text-3xl font-bold text-foreground mt-12">5. Data Security</h2>
            <p>We implement reasonable security measures, but no method is 100% secure. We cannot guarantee absolute protection.</p>

            <h2 className="text-3xl font-bold text-foreground mt-12">6. Your Rights</h2>
            ...
            <h2 className="text-3xl font-bold text-foreground mt-12">7. Children's Privacy</h2>
            <p>Our services are not intended for individuals under 18. We do not knowingly collect data from children.</p>

            <h2 className="text-3xl font-bold text-foreground mt-12">8. Changes to This Policy</h2>
            <p>We may update this policy. Changes will be posted here with the updated date. Review periodically.</p>

            <h2 className="text-3xl font-bold text-foreground mt-12">9. Contact Us</h2>
            <p>For any questions, reach out at:</p>
            <p className="mt-2">
              Email: hello@rahulmotion.com<br />
              Website: [yourwebsite.com/contact]
            </p>
          </div>
        </motion.div>
      </div>
