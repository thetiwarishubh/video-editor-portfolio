      ...
      <div className="container mx-auto px-6 md:px-12 max-w-4xl">
        ...
        >
          ...
          <div className="prose prose-invert max-w-none space-y-8 text-muted-foreground">
            ...
            <h2 className="text-3xl font-bold text-foreground mt-12">1. Services</h2>
            ...
            <h2 className="text-3xl font-bold text-foreground mt-12">2. Payment Terms</h2>
            ...
            <h2 className="text-3xl font-bold text-foreground mt-12">3. Intellectual Property & Rights</h2>
            ...
            <h2 className="text-3xl font-bold text-foreground mt-12">4. Revisions & Scope</h2>
            ...
            <h2 className="text-3xl font-bold text-foreground mt-12">5. Timeline & Delivery</h2>
            ...
            <h2 className="text-3xl font-bold text-foreground mt-12">6. Termination & Cancellation</h2>
            <p>Either party may terminate with written notice. You pay for work completed. Deposits are non-refundable.</p>

            <h2 className="text-3xl font-bold text-foreground mt-12">7. Limitation of Liability</h2>
            ...
            <h2 className="text-3xl font-bold text-foreground mt-12">8. Governing Law</h2>
            <p>These Terms are governed by the laws of India. Disputes shall be resolved in the courts of [your city/state].</p>

            <h2 className="text-3xl font-bold text-foreground mt-12">9. Contact</h2>
